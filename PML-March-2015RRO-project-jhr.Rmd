...
Removing user_name as a predictor caused a slight increase in overall accuracy with the training2 set, and it’s performance on testing2 and on the submitted test set was excellent. 
I conclude that removing user_name from predictors was an acceptable approach to building the predictive model.
